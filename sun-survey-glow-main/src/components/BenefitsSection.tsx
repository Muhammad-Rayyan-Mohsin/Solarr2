...
const benefits = [
  {
    ...
    description: 'Guided multi-section survey to capture your information systematically.'
  },
  {
    icon: DollarSign,
    emoji: '⚡',
    title: 'Quick Process',
    description: 'Streamlined questions designed to take just a few minutes to complete.'
  },
  {
    icon: Shield,
    emoji: '🛡️',
    title: 'No Commitment',
    description: 'No signup required, no sales calls, and no hidden requirements.'
  },
  {
    icon: Zap,
    emoji: '📄',
    title: 'Clear Structure',
    description: 'Organized sections including General & Contact and Electricity Baseline.'
  }
];
