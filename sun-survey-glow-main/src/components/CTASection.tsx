      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Join thousands of homeowners who have already discovered their solar savings potential. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
            <Button 
              ...
              className="bg-white text-primary hover:bg-white/90 px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all group"
            >
              Start Survey Now
